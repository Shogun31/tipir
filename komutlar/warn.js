...
if(!message.member.hasPermission('KICK_MEMBERS')) return message.reply("🚫 Bu komutu kullanabilmek için `Üyeleri At` yetkisine ihtiyacın var.")
...
if(kullanıcı.bot) return message.reply(`🚫 Botları uyaramazsın! `) 
