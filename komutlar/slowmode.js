...
const limit = args[0] ? args[0] : 0;
  if(!limit) {
              var embed = new Discord.MessageEmbed()
                .setDescription(`🚫 Doğru kullanım: \`!slowmode [0/120]\``)//Vinnie tarafından kodlanmıştır.
                .setColor("#ff0000")
...
if (limit > 120) {
    return message.channel.send(new Discord.MessageEmbed().setDescription("🚫 Süre limiti maksimum **120** saniye olabilir.").setColor("#19b9c9"));
}
